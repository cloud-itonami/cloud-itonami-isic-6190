# Operator Quickstart — Community Telecommunications Access

Shortest path from clone to a verified local dry-run for **ISIC 6190** (`cloud-itonami-isic-6190`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-6190.git
cd cloud-itonami-isic-6190
```
...
- Blueprint governor key: `telecom-access-governor`
- Likely source path: `telecom.governor.cljc`
